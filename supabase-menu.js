(() => {
  ...
  function normalizeImage(url){if(!url)return '';return url.startsWith('/')?url.slice(1):url}
  ...
  function itemImage(item){return normalizeImage(item.image_url)}
